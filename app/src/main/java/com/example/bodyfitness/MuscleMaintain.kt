...
import com.example.bodyfitness.databinding.ActivityMuscleMaintainBinding

class MuscleMaintain : AppCompatActivity() {
    private var binding: ActivityMuscleMaintainBinding?= null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding=ActivityMuscleMaintainBinding.inflate(layoutInflater)
